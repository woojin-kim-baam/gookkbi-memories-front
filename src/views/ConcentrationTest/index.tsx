...
export default function ConcentrationTest() {
    ...
    const postConcentrationResponse = (responseBody: ResponseDto) => {
        const message = 
        !responseBody ? '서버에 문제가 있습니다' :
        responseBody.code === 'DBE' ? '서버에 문제가 있습니다' :
        responseBody.code === 'AF' ? '인증에 실패 했습니다' : "";
    ...
    useEffect(() => {
        ...
        if(isStarted) {
            ...
            }, Math.floor(TOTAL_TIME / STAT_COUNT));
        }
        ...
        <div className='container'>
            ...
            <div className='test-box'>
                ...
                <div className='test-container'>
                    ...
                    {isStarVisible ? 
                    <div className='star' onClick={onIconClickHanlder}></div> :    
                    <div className='rectangle' onClick={onIconClickHanlder}></div>
                }
                </div> : 
