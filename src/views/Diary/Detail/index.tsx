...
export default function DiaryDetail() {
  ...
  const getDiaryResponse = (responseBody: GetDiaryResponseDto | ResponseDto | null) => {
    ...
    const { writerId, writeDate, weather, feeling, title, content } =
      responseBody as GetDiaryResponseDto;
        ...
        <div className="contents-container">
          ...
          <div className="sub-container">
            <div className="header">
              ...
              <div className="sub-box">
                <div className="icon comment" /> {comments.length}
              </div>
            </div>
            <div className="body">
              {comments.map((commentItem, index)=><CommentItem key={index} commentItem={commentItem} /> )}
            </div>
